...
if(isset($_POST['add_post'])){
   ...
   $insert_query = "INSERT INTO blog (blog_cat_id, blog_sub_cat_id, blog_title,blog_feature_img,blog_disc,status) VALUES ('".$post_category."','".$post_sub_cat."','".$post_title."','".$post_img."','".$post_Desc."','".$post_status."')";                                      
    ...
    <div id="wrapper">
       ...
       <?php include('include/side_baradd.php');?>
        ...
        <div class="" style="min-height:84.5vh;">
            ...
            <h1 class="m-0 font-weight-bold text-primary float-left">Add Post</h1>
            ...
            <form method="POST" enctype="multipart/form-data" class="py-4">
                ...
                <button type="submit" name="add_post" class="btn btn-outline-secondary">Publish</button>
                </form>
