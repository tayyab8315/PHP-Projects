...
$register_query= "SELECT * FROM register WHERE 	email = '".$user_name."' AND password = '".$password."'";
                            ...
                            <div class="col-lg-6" style=" background-color: #000; color:#ffc107;">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4  mb-4 "  style=" color:#ffc107;">Welcome Back!</h1>
                                    </div>
                                    <form class="user"  method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" name="login" class="btn  btn-user btn-block" style=" background-color:#ffc107; color:#000;">
                                            Login
</button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.php" style=" color:#ffc107;">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="register.php" style=" color:#ffc107;">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
