...
while($row    = mysqli_fetch_array($data)){
    ...
    $category .= '<option class="form-control" value='.$blog_catid.'>'.$blog_cat.'</option>';
}

if(isset($_POST['add_blog_sub_cat'])){
   $blog_cat       = $_POST['blog_cat'];
   $blog_sub_cat   = $_POST['blog_sub_cat'];

   $insert_query = "INSERT INTO blog_sub_cat  (blog_cat_id,blog_sub_cat)
                                             VALUES
                                             ('".$blog_cat."','".$blog_sub_cat."')";
       ...
       <?php include('include/side_baradd.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="m-0 font-weight-bold text-primary float-left">Add Blog Sub Category</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                
                <a href="manage_blog_sub_cat.php" type="button" class="btn btn-sm btn-danger">
                    Back
                </a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="blog_sub_cat">
                            </div>
                    </div>
                </div>
                <button type="submit" name="add_blog_sub_cat" class="btn btn-outline-secondary">Submit</button>
                </form>
