...
$update_id= $_GET['update_cat_id'];
}

if(isset($_POST['upd_cat'])){
    $update_cat              = $_POST['category2'];
    ...
    $update_category = "UPDATE manage_category SET category='".$update_cat ."' , cat_img='".$cat_img ."' WHERE cat_id='".$update_id."'" ;
    ...
    <div id="wrapper" >
       ...
       <?php include('include/side_baradd.php');?>
        ...
        <div class="" style="min-height:84.5vh;">
            ...
            <h1 class="m-0 font-weight-bold text-primary float-left">Update Category</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                
                <a href="manage_category.php" type="button" class="btn btn-sm btn-danger">
                    Back
                </a>
                </div>
            </div>
            ...
            <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" name="category2" value="" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                    ...
                    <button type="submit" name="upd_cat" class="btn btn-outline-primary ms-2 mt-5">Update</button>
                </div>
