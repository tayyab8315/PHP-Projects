...
if(isset($_POST['add_product'])){
   ...
   $insert_query = "INSERT INTO manege_product (category, sub_category, product_title, product_price,avg_rating, product_desc,product_img,sub_img1,sub_img2,sub_img3,sub_img4,product_status) VALUES ('".$prod_category."','".$sub_cat."','".$prod_tit."','".$product_price."',0,'".$product_Desc."','".$product_img."','".$product_sub_img1."','".$product_sub_img2."','".$product_sub_img3."','".$product_sub_img4."','".$product_status."')";                                      
    ...
    <div id="wrapper">
       ...
       <?php include('include/side_baradd.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <h1 class="m-0 font-weight-bold text-primary float-left">Add Products</h1>
