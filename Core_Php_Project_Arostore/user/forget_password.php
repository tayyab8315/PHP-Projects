...
<img src="assets/images/Blog-3-720x484-removebg-preview.png" class="img-fluid" alt="Forget_password_banner_img">
</div>
<div class="col-12 col-md-6 g-0 form_right">
    ...
    <form method="post" class="  m-1 px-1 m-sm-4 px-sm-4 m-md-2 px-md-2  pt-lg-3 m-lg-3 px-lg-3" enctype="multipart/form-data">
        ...
        <button type="submit" name="find" class="btn  login_btn login_button">Find Mail <i class="fa-solid fa-arrow-right-to-bracket"></i></button>
        <br>
        <br>
        <br>
        <?php echo $show ;?>
